...
const AdminLogin: React.FC<{ onLogin: (success: boolean) => void }> = ({ onLogin }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulation
    setTimeout(() => {
      if (email === 'admin@tradeplaybooks.com' && password === 'admin') {
        onLogin(true);
      } else {
        // Allow old creds for convenience or strictly new ones
        if ((email === 'admin@perpetualplaybook.com' || email === 'admin@tradeplaybooks.com') && password === 'admin') {
          onLogin(true);
        } else {
          alert('Invalid credentials. (Hint: admin@tradeplaybooks.com / admin)');
          setLoading(false);
        }
      }
    }, 1000);
    ...
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="bg-[#0F0F12] p-10 rounded-3xl w-full max-w-md relative z-10 border border-white/10 shadow-2xl backdrop-blur-xl">
        <div className="mb-8 text-center">
          <h2 className="font-bold text-3xl text-white mb-2 italic tracking-tight">Trade <span className="text-brand-teal">Portal</span></h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              placeholder="admin@tradeplaybooks.com"
            />
          </div>
          <div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10">
            <code className="text-[11px] text-brand-purple font-mono">admin@tradeplaybooks.com</code>
